    ...
    <section className="card">
      ...
      {loading && runs.length === 0 ? (
        ...
        <EmptyState
          icon="📋"
          title="No runs yet"
          description="Start a pipeline above to see execution history here"
          helpText="Each run captures all generated files, readiness scores, and deployment configs"
        />
      ) : (
