...
from apps.stripe_engine.webhook_events import sanitize_stripe_value
...
class FetchStripeEventTests(SimpleTestCase):
    @patch("apps.stripe_engine.webhook_events.get_secret", return_value="sk_test_x")
    @patch("apps.stripe_engine.webhook_events.stripe.Event.retrieve")
