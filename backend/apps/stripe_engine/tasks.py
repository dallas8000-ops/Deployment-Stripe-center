...
def health_monitor_all_projects_task() -> dict:
    ...
    from apps.stripe_engine.health_monitor import run_all_projects_health_monitor
...
def anomaly_detection_all_projects_task() -> dict:
    ...
    from apps.stripe_engine.anomaly_detection import run_all_projects_anomaly_detection
...
def auto_backup_all_projects_task() -> dict:
    ...
    from apps.stripe_engine.backup_recovery import create_project_backup
