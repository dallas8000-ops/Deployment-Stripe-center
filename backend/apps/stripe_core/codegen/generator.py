...
def _generate_django(ctx: dict[str, Any]) -> dict[str, str]:
    return {
        "stripe_billing/__init__.py": "",
        "stripe_billing/client.py": _render("django/client.py.j2", ctx),
        "stripe_billing/db.py": _render("django/db.py.j2", ctx),
        "stripe_billing/webhook_handlers.py": _render("django/webhook_handlers.py.j2", ctx),
        "stripe_billing/views.py": _render("django/views.py.j2", ctx),
        "stripe_billing/urls.py": _render("django/urls.py.j2", ctx),
        "stripe_billing/templates/stripe/pricing.html": _render("django/pricing.html.j2", ctx),
        "stripe_billing/templates/stripe/success.html": _render("django/success.html.j2", ctx),
        "stripe_billing/templates/stripe/account.html": _render("django/account.html.j2", ctx),
