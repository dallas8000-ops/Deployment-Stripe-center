...
# Starter: price_1ThJVmRxznXvj6jhqPmFSLNM
# Pro: price_1ThJVmRxznXvj6jh2aTzRO4V
# Enterprise: price_1ThJVnRxznXvj6jhy8uXBJ0z
...
def checkout(request):
    ...
    app_url = os.environ.get("APP_URL", "https://stripe-installer-production.up.railway.app")
    user_id = None
...
STRIPE_TIERS = [
    {"key": "starter", "tier": "Starter", "price_id": "price_1ThJVmRxznXvj6jhqPmFSLNM", "label": "$9.00/month"},
    {"key": "pro", "tier": "Pro", "price_id": "price_1ThJVmRxznXvj6jh2aTzRO4V", "label": "$29.00/month"},
    {"key": "enterprise", "tier": "Enterprise", "price_id": "price_1ThJVnRxznXvj6jhy8uXBJ0z", "label": "$990.00/year"},
]
